    ...
    def get_available_models(self) -> Dict[str, Dict[str, str]]:
        try:
            if self.provider == "google":
                ...
                self.available_models = {
                    "LLaMA 3 8B (Groq)": {"id": "llama3-8b-8192"},
                    "LLaMA 3 70B (Groq)": {"id": "llama3-70b-8192"},
                    "Mixtral 8x7B (Groq)": {"id": "mixtral-8x7b-32768"}
                }
        ...
        try:
            ...
            if self.provider == "google":
                ...
                completion = self.client.chat.completions.create(
                    model=model_id,
                    messages=[
                        {"role": "system", "content": "You generate structured Question and Answer pairs."},
                        {"role": "user", "content": prompt}
                    ],
                    temperature=0
                )
                raw_qa = completion.choices[0].message.content
